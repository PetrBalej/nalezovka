...
<html lang="en" class="h-100">
    <head>
        ...
        <style>
            ...
            /* custom */
            pre {margin: 20px; padding: 10px; background-color: #F0F0F0; border-radius: 10px; border: 1px dotted gray; font-size: 70%; white-space: pre-wrap;}
    ...
    <body class="d-flex flex-column h-100">
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                <a class="navbar-brand" href="/nalezovka/">Nálezovka</a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/nalezovka/index.php/tabulka">Tabulka<span class="sr-only">(aktivní)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/nalezovka/index.php/nej">Nej- N/S/E/W</a>
                        </li>
                        <li class="nav-item">
